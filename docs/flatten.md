...
- [sandboxer/docs/sandbox.md](https://github.com/kuasar-sandbox/sandboxer/blob/main/docs/sandbox.md) [Strict encoding and limits](https://github.com/kuasar-sandbox/sandboxer/blob/main/docs/sandbox-artifacts.md#33-strict-encoding-and-limits): how startup uses the embedded OCI runtime configuration.
