...
- [sandboxer/docs/sandbox.md](https://github.com/kuasar-sandbox/sandboxer/blob/main/docs/sandbox.md) §3.1 (`boot.kernel`) and [artifact compatibility](https://github.com/kuasar-sandbox/sandboxer/blob/main/docs/sandbox-artifacts.md#144-incompatibility): kernel references and custom-kernel integration.
