...
validate_tag() {
  [[ "$1" =~ ^(runtime|vmlinux)-v(0|[1-9][0-9]*)\.(0|[1-9][0-9]*)\.(0|[1-9][0-9]*)(-preview\.[0-9]{8})?$ ]] \
    || fail "tag must match runtime-vX.Y.Z or vmlinux-vX.Y.Z, optionally followed by -preview.YYYYMMDD"
}
